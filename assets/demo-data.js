...
window.DEMO_SEED = {
  ...
  tickets: [
    ...
    { id:'t24', ref:'TKT-00024', companyId:'C2', departmentId:'dep3', subject:'Password reset not arriving', description:'Reset emails are delayed by 20+ minutes.', categoryId:'cat4', severity:'Minor', priority:'P3', status:'Resolved', ticketType:'INCIDENT', createdBy:'u6', assignedTo:'u2', createdAt:'2026-06-25T09:30:00', updatedAt:'2026-06-28T12:00:00', resolvedAt:'2026-06-28T12:00:00', closedAt:null, slaDueDate:'2026-07-02T09:30:00', csatScore:null, firstResponseAt:'2026-06-26T14:00:00', resolutionCode:'FIXED', resolutionSummary:'Investigated mail relay configuration — password reset emails were queuing behind bulk marketing sends. Adjusted priority routing rules.', reopenCount:0 },
